...
internal final class Auth_AuthServiceClient: ServiceClientBase, Auth_AuthService {
  /// Synchronous. Unary.
  internal func auth(_ request: Auth_AuthRequest) throws -> Auth_AuthResponse {
    return try Auth_AuthAuthCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func auth(_ request: Auth_AuthRequest, completion: @escaping (Auth_AuthResponse?, CallResult) -> Void) throws -> Auth_AuthAuthCall {
    return try Auth_AuthAuthCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func verify(_ request: Auth_VerifyRequest) throws -> Auth_VerifyResponse {
    return try Auth_AuthVerifyCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func verify(_ request: Auth_VerifyRequest, completion: @escaping (Auth_VerifyResponse?, CallResult) -> Void) throws -> Auth_AuthVerifyCall {
    return try Auth_AuthVerifyCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func refresh(_ request: Auth_RefreshRequest) throws -> Auth_RefreshResponse {
    return try Auth_AuthRefreshCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func refresh(_ request: Auth_RefreshRequest, completion: @escaping (Auth_RefreshResponse?, CallResult) -> Void) throws -> Auth_AuthRefreshCall {
    return try Auth_AuthRefreshCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }

  /// Synchronous. Unary.
  internal func parse(_ request: Auth_ParseRequest) throws -> Auth_ParseResponse {
    return try Auth_AuthParseCallBase(channel)
      .run(request: request, metadata: metadata)
  }
  /// Asynchronous. Unary.
  internal func parse(_ request: Auth_ParseRequest, completion: @escaping (Auth_ParseResponse?, CallResult) -> Void) throws -> Auth_AuthParseCall {
    return try Auth_AuthParseCallBase(channel)
      .start(request: request, metadata: metadata, completion: completion)
  }
